    ...
    <div class="w-full mt-10 grid md:grid-cols-[1fr_322px] gap-5">
        ...
        <div class="relative h-[460px]">
          ...
          <div class="absolute top-0 w-full h-full p-10 grid">
            ...
            <div class="self-baseline justify-self-center">
              <button
                class="rounded-[32px] mt-4 pl-2.5 pr-6 py-1 flex flex-row items-center gap-x-4 text-white bg-[#FE4444]">
      ...
      <div class="rounded-lg w-full h-[750px] p-2 bg-blue-50">
        <span class="flex justify-end cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 fill-white" viewBox="0 0 384 512">
