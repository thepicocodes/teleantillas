...
<header class="border-b py-4 px-5 bg-blue-50">
	<div class="w-full max-w-screen-xl mx-auto flex flex-row items-center justify-between xl:justify-between gap-x-2">
		<a href="" class="block shrink-0">
			<img src="<?php echo get_template_directory_uri(); ?>/images/logo-teleantillas.png"
				srcset="<?php echo get_template_directory_uri(); ?>/images/logo-teleantillas@2x.png 2x"
				alt="Logo Telesistema"
				class="block h-[93px] w-[130px]">
		</a>
		...
		<nav id="navigation" class="hidden xl:flex w-full h-screen xl:h-auto flex-col xl:flex-row items-center xl:justify-center gap-x-1 absolute xl:static left-0 bg-white xl:bg-inherit z-50 <?php echo is_user_logged_in() ? 'top-10' : 'top-0' ?>">
			<ul id="nav-links" class="w-full h-screen md:h-auto md:w-fit flex flex-col gap-y-5 xl:flex-row xl:items-center gap-x-1 px-5 xl:px-0 text-lightBlue-100 text-sm font-bold">
				...
				<li><a href="<?php echo esc_url(home_url('/Programación')); ?>" class="block w-full md:w-fit px-1 py-2 text-s-b hover:text-yellow-YellowTeleantillas">Información y opinión</a></li>
				<li><a href="<?php echo esc_url(home_url('/Noticias')); ?>" class="block w-full md:w-fit px-1 py-2 text-s-b hover:text-yellow-YellowTeleantillas">Novelas</a></li>
				<li><a href="<?php echo esc_url(home_url('/Contacto')); ?>" class="block w-full md:w-fit px-1 py-2 text-s-b hover:text-yellow-YellowTeleantillas">Películas</a></li>
				<li><a href="<?php echo esc_url(home_url('/Contacto')); ?>" class="block w-full md:w-fit px-1 py-2 text-s-b hover:text-yellow-YellowTeleantillas">Deportes</a></li>
				<li><a href="<?php echo esc_url(home_url('/Contacto')); ?>" class="block w-full md:w-fit px-1 py-2 text-s-b hover:text-yellow-YellowTeleantillas">Noticias</a></li>
				<li class="w-max"><a href="<?php echo esc_url(home_url('/')); ?>" class="rounded-lg inline px-2 py-1 text-s-b text-white font-lato bg-yellow-YellowTeleantillas">En vivo</a></li>
			</ul>
		</nav>
		...
		<div class="flex flex-row items-center gap-x-5">
			...
			<ul class="relative flex flex-row items-center gap-x-4">
				...
				<a href="#" id="navbar-toggler" class="block xl:hidden">
					<svg xmlns="http://www.w3.org/2000/svg" class="h-5 fill-yellow-YellowTeleantillas" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
