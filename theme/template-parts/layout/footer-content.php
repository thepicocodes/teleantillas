...
<footer class="mt-24 bg-blue-50">
	<div class="w-full px-10 pt-24">
		<div class="w-full max-w-[1240px] mx-auto grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-10 text-white">
			<a href=""
				...
				<img src="<?php echo get_template_directory_uri(); ?>/images/logo-teleantillas.png"
					srcset="<?php echo get_template_directory_uri(); ?>/images/logo-teleantillas@2x.png 2x" alt="Logo teleantillas"
					class="block h-[93px] w-[130px]">
			</a>

			<div class="">
				<h4 class="font-extrabold uppercase text-sm text-blue-100">Secciones</h4>
			...
			<div class="">
				<h4 class="font-extrabold uppercase text-sm text-blue-100">últimas</h4>
				<ul class="mt-2.5 grid gap-y-2.5">
					<li>
			...
			<div class="">
				<h4 class="font-extrabold uppercase text-sm text-blue-100">Otros enlaces</h4>
				<ul class="mt-2.5 grid gap-y-2.5">
					<li>
					...
					<li>
						<a href="" class="block w-full py-2 lg:py-0">Configuración de cookies</a>
					</li>
					<li>
						<a href="" class="block w-full py-2 lg:py-0">Ayuda</a>
					</li>
					<li>
						<a href="" class="block w-full py-2 lg:py-0">Publicidad</a>
					</li>
					<li>
						<a href="" class="block w-full py-2 lg:py-0">Articles & Resources</a>
					</li>
					<li>
						<a href="" class="block w-full py-2 lg:py-0">Pregunta frecuentes</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="border-t border-b mt-12">
			<ul
				...
				<li class="">
					<img src="<?php echo get_template_directory_uri(); ?>/images/ts-logo.png" alt="Telesistemas"
						class="h-[60px] object-contain">
				</li>
				<li class="">
					<img src="<?php echo get_template_directory_uri(); ?>/images/telenoticias-logo.png" alt="Telenoticias"
						class="h-[60px] object-contain">
				</li>
				<li class="">
					<img src="<?php echo get_template_directory_uri(); ?>/images/aym-logo.png" alt="Arte y medio"
						class="h-[60px] object-contain">
				</li>
				<li class="">
		...
		<div class="py-9 flex flex-col lg:flex-row items-center justify-between gap-y-5 text-white">
			<p>© Copyright - Grupo de Comunicación Corripio<br class="md:hidden"> • <a href="#" title="">Políticas de
					Privacidad</a> • <a href="#" title="">Términos y condiciones</a></p>
			<div>
				<ul class="mt-10 md:mt-0 flex flex-wrap items-center gap-y-12 gap-x-12 lg:gap-4">
					<li>
						<a href="">
